...
interface AlertOnRegularIconProps {
  size?: number;
  color?: string;
  style?: StyleProp<ViewStyle>;
}

export const AlertOnRegularIcon: React.FC<AlertOnRegularIconProps> = ({
